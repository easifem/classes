...
USE GmshBasicInterface, ONLY: GmshInitialize
USE GmshBasicInterface, ONLY: GmshFinalize
USE GmshBasicInterface, ONLY: GmshIsInitialized
USE GmshBasicInterface, ONLY: GmshOpen
