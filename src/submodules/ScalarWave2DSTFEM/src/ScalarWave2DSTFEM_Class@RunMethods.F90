SUBMODULE(ScalarWave2DSTFEM_Class) RunMethods
...
DO itime = 1, obj%algoParam%totalTimeElements
  CALL obj%algoParam%SetTij(itime)

  CALL Display(obj%algoParam%currentTime, myname//" current time: ")
