...
SUBMODULE(ScalarWave2DSTFEM_Class) WriteDataMethods
...
isOk = MOD(obj%algoParam%currentTimeStep - 1, obj%OutputFreq) &
       .NE. 0_I4B
IF (isOk) RETURN

suffix = tostring(obj%algoParam%currentTimeStep - 1)
path = obj%result_dir
