...
SUBMODULE(ScalarWave2DSTFEM_Class) SetMethods
...
obj%algoParam%currentTimeStep = 1
obj%algoParam%currentTime = obj%algoParam%timeDomain(1)
CALL obj%algoparam%Set(1)
