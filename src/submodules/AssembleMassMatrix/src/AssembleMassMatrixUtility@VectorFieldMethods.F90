...
SUBMODULE(AssembleMassMatrixUtility) VectorFieldMethods
...
!----------------------------------------------------------------------------
!                                         VectorFieldAssembleMassMatrix
!----------------------------------------------------------------------------

MODULE PROCEDURE VectorFieldAssembleMassMatrix1
#ifdef DEBUG_VER
CHARACTER(*), PARAMETER :: myName = "VectorFieldAssembleMassMatrix1()"
#endif
...
CALL e%RaiseInformation(modName//'::'//myName//' - '// &
                        '[END] ')
#endif
END PROCEDURE VectorFieldAssembleMassMatrix1
