...
SUBMODULE(Abstract1DUVSTFEM_Class) UpdateMethods
...
tcompo = obj%totalDOFTime(obj%currentTimeStep)
...
DO ii = 1, nnt
  ...
  CALL RealVector_Add(obj1=obj%v0, dofobj1=obj%dof, idof1=1_I4B, &
                      obj2=obj%sol, dofobj2=obj%dof, idof2=ii + tcompo, &
                      scale=scale)
END DO
