...
SUBMODULE(Test_ReferenceElement_Class) Methods
USE BaseMethod
IMPLICIT NONE
CONTAINS
...
MODULE PROCEDURE refelem_Initiate
  CHARACTER( LEN = * ), PARAMETER :: myName="refelem_Initiate"
  CALL e%raiseError(modName //'::'//myName// ' - '// &
    & 'This routine cannot be called for ReferenceElement_')
...
MODULE PROCEDURE refelem_GetFacetElements
  CHARACTER( LEN = * ), PARAMETER :: myName="refelem_GetFacetElements"
  CALL e%raiseError(modName //'::'//myName// ' - '// &
...
MODULE PROCEDURE refelem_GetFacetTopology
  CHARACTER( LEN = * ), PARAMETER :: myName="refelem_GetFacetTopology"
  CALL e%raiseError(modName //'::'//myName// ' - '// &
    & 'This routine cannot be called from ReferenceElement_')
