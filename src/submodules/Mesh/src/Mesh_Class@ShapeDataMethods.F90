...
MODULE PROCEDURE obj_initiateElemSD1
...
END PROCEDURE obj_initiateElemSD1

!----------------------------------------------------------------------------
!                                                             InitiateElemSD
!----------------------------------------------------------------------------

MODULE PROCEDURE obj_initiateElemSD2
...
END PROCEDURE obj_initiateElemSD2

!----------------------------------------------------------------------------
!                                                             InitiateElemSD
!----------------------------------------------------------------------------

MODULE PROCEDURE obj_initiateElemSD3
...
END PROCEDURE obj_initiateElemSD3

!----------------------------------------------------------------------------
!                                                             InitiateElemSD
!----------------------------------------------------------------------------

MODULE PROCEDURE obj_initiateElemSD4
INTEGER(I4B) :: ii
...
END PROCEDURE obj_initiateElemSD4

!----------------------------------------------------------------------------
!                                                            InitiateElemSD
!----------------------------------------------------------------------------

MODULE PROCEDURE obj_initiateFacetElemSD1
...
END PROCEDURE obj_initiateFacetElemSD1

!----------------------------------------------------------------------------
!                                                             InitiateElemSD
!----------------------------------------------------------------------------

MODULE PROCEDURE obj_initiateFacetElemSD2
...
END PROCEDURE obj_initiateFacetElemSD2

!----------------------------------------------------------------------------
!                                                             InitiateElemSD
!----------------------------------------------------------------------------

MODULE PROCEDURE obj_initiateFacetElemSD3
...
END PROCEDURE obj_initiateFacetElemSD3
