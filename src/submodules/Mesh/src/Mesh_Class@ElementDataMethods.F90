...
!   & iel2, iFace2, NNS2, localElem1, temp4(4), xidim
...
! END IF
!
! problem = obj%isElementToElements()
! IF (problem) THEN
...
!
! CALL obj%SetParam(isElementToElementsInitiated=.true.)
!
! isok = obj%isNodeToElements()
! IF (.NOT. isok) CALL obj%InitiateNodeToElements()
!
! DO localElem1 = 1, obj%GetTotalElements()
