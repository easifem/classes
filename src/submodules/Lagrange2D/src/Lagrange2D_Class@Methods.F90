...
SUBROUTINE Initiate1(ans, i, x, order, varname1, varname2, elemType)
...
SUBROUTINE Initiate2(ans, i, v, order, varname1, varname2, elemType)
  CLASS(Lagrange2D_), INTENT(INOUT) :: ans
  INTEGER(I4B), INTENT(IN) :: i
...
SUBROUTINE Initiate3(ans, i, v, ipiv, order, varname1, varname2, elemType)
  CLASS(Lagrange2D_), INTENT(INOUT) :: ans
  INTEGER(I4B), INTENT(IN) :: i
...
SUBROUTINE Initiate4(ans, x, order, varname1, varname2, elemType)
...
CALL Initiate1(ans=ans, i=i, x=x, order=order, varname1=varname1, &
...
CALL Initiate2(ans=ans, i=i, v=v, order=order, varname1=varname1, &
  & varname2=varname2, elemType=elemType)
...
CALL Initiate4(ans=ans, x=x, order=order, varname1=varname1, &
  & varname2=varname2, elemType=elemType)
