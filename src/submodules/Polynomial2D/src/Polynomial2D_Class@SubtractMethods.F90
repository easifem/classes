...
SUBMODULE(Polynomial2D_Class) SubtractMethods
USE BaseMethod
IMPLICIT NONE
CONTAINS
...
MODULE PROCEDURE func_Subtract_mono_mono
  !!
  REAL( DFP ), PARAMETER :: coeff( 2 ) = [1.0_DFP, -1.0_DFP]
  INTEGER( I4B ) :: degree( 2, 2 )
  TYPE( String ) :: varname( 2 )
  !!
...
#include "./inc/Monomial2D_Class_Subtract_obj_scalar.inc"
...
#include "./inc/Monomial2D_Class_Subtract_scalar_obj.inc"
...
#include "./inc/Polynomial2D_Class_Subtract_obj_scalar.inc"
...
#include "./inc/Polynomial2D_Class_Subtract_scalar_obj.inc"
