...
SUBMODULE(Polynomial2D_Class) MultiplicationMethods
USE BaseMethod
IMPLICIT NONE
CONTAINS
...
MODULE PROCEDURE func_Multiplication_obj_obj
  ...
  CALL REALLOCATE( degree, n1*n2, 2 )
  !!
  kk = 0
  DO ii = 1, n1
    DO jj = 1, n2
...
#include "./inc/Monomial2D_Class_Multiplication_obj_scalar.inc"
...
#include "./inc/Monomial2D_Class_Multiplication_scalar_obj.inc"
...
#include "./inc/Polynomial2D_Class_Multiplication_obj_scalar.inc"
...
#include "./inc/Polynomial2D_Class_Multiplication_scalar_obj.inc"
