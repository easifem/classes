...
SUBMODULE(ConstNeumannBC_Class) Methods
...
!----------------------------------------------------------------------------
!                                                        GetConstNeumannBCPointer
!----------------------------------------------------------------------------

MODULE PROCEDURE obj_GetConstNeumannBCPointer
#ifdef DEBUG_VER
CHARACTER(*), PARAMETER :: myName = "obj_GetConstNeumannBCPointer()"
LOGICAL(LGT) :: isok
#endif
...
CALL e%RaiseInformation(modName//'::'//myName//' - '// &
                        '[END] ')
#endif
END PROCEDURE obj_GetConstNeumannBCPointer
