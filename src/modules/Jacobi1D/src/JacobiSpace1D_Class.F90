...
CONTAINS
  ...
  PROCEDURE, PUBLIC, PASS(obj) :: Display => Orthopol_Display
    !! Display the content of Jacobi polynomial
...
!----------------------------------------------------------------------------
!                                                      JacobiSpace1D@Methods
!----------------------------------------------------------------------------

!> authors: Vikas Sharma, Ph. D.
! date: 4 Aug 2022
! summary: Constructor for space of Jacobi polynomials

INTERFACE
  MODULE FUNCTION JacobiSpace1D1(alpha, beta) RESULT(ans)
...
INTERFACE
  MODULE FUNCTION JacobiSpace1D_Pointer1(alpha, beta) &
    & RESULT(ans)
    REAL(DFP), INTENT(IN) :: alpha
    !! alpha > -1.0
    REAL(DFP), INTENT(IN) :: beta
...
!> author: Vikas Sharma, Ph. D.
! date: 17 Oct 2022
! summary: Evaluates the gradient of Jacobi (order = n ) at single point.
...
!> author: Vikas Sharma, Ph. D.
! date: 17 Oct 2022
! summary: Evaluates the gradient of Jacobi (order=n) at several points.
...
!> author: Vikas Sharma, Ph. D.
! date: 17 Oct 2022
! summary: Evaluates the gradient of Jacobi series at single point.
...
!> author: Vikas Sharma, Ph. D.
! date: 17 Oct 2022
! summary: Evaluates the gradient of Jacobi series at several points.
