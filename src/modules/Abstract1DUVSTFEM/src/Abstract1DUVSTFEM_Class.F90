...
MODULE Abstract1DUVSTFEM_Class
...
PUBLIC :: Abstract1DUVSTFEM_
PUBLIC :: Abstract1DUVSTDeallocate
PUBLIC :: Abstract1DUVSTImportFromToml
PUBLIC :: Abstract1DUVSTWriteData
PUBLIC :: Abstract1DUVSTSet
PUBLIC :: Abstract1DUVSTUpdate
PUBLIC :: Abstract1DUVSTSetInitialVelocity
PUBLIC :: Abstract1DUVSTApplyDirichletBC
PUBLIC :: Abstract1DUVSTAssembleTanmat
PUBLIC :: Abstract1DUVSTAssembleRHS
PUBLIC :: ElementDataImportFromToml

CHARACTER(*), PARAMETER :: modName = 'Abstract1DUVSTFEM_Class'
CHARACTER(*), PARAMETER :: prefix = "Abstract1DUVSTFEM"
CHARACTER(*), PARAMETER :: default_result_dir = "./results"
CHARACTER(*), PARAMETER :: default_filename = "Abstract1DUVSTFEM"
...
! date:   2025-02-14
! summary:  Abstract class for 1D UVSTFEM

TYPE, ABSTRACT :: Abstract1DUVSTFEM_

  !! NOTE: currently the same setup related temporal dimension
  !! is applied to both u and v
  ...
  INTEGER(I4B) :: dbc_idof(4 * MAX_ORDER_TIME + 2)
  !! internal use only
  ...
  REAL(DFP) :: dbc_value(4 * MAX_ORDER_TIME + 2)
  !! internal use only
  !! used in ApplyDirichletBCLeft
...
INTERFACE
  MODULE SUBROUTINE obj_Initiate(obj, param)
    CLASS(Abstract1DUVSTFEM_), INTENT(INOUT) :: obj
...
INTERFACE Abstract1DUVSTDeallocate
  MODULE SUBROUTINE obj_Deallocate(obj)
    CLASS(Abstract1DUVSTFEM_), INTENT(INOUT) :: obj
  END SUBROUTINE obj_Deallocate
END INTERFACE Abstract1DUVSTDeallocate
...
INTERFACE Abstract1DUVSTImportFromToml
  MODULE SUBROUTINE obj_ImportFromToml1(obj, table)
    CLASS(Abstract1DUVSTFEM_), INTENT(INOUT) :: obj
    TYPE(toml_table), INTENT(INOUT) :: table
  END SUBROUTINE obj_ImportFromToml1
END INTERFACE Abstract1DUVSTImportFromToml
...
INTERFACE Abstract1DUVSTSet
  MODULE SUBROUTINE obj_Set(obj)
    CLASS(Abstract1DUVSTFEM_), INTENT(INOUT) :: obj
  END SUBROUTINE obj_Set
END INTERFACE Abstract1DUVSTSet
...
INTERFACE Abstract1DUVSTSetInitialVelocity
  MODULE SUBROUTINE obj_SetInitialVelocity(obj)
    CLASS(Abstract1DUVSTFEM_), INTENT(INOUT) :: obj
  END SUBROUTINE obj_SetInitialVelocity
END INTERFACE Abstract1DUVSTSetInitialVelocity
...
INTERFACE Abstract1DUVSTUpdate
  MODULE SUBROUTINE obj_Update(obj)
    CLASS(Abstract1DUVSTFEM_), INTENT(INOUT) :: obj
  END SUBROUTINE obj_Update
END INTERFACE Abstract1DUVSTUpdate

!----------------------------------------------------------------------------
!                                                         WriteData@Methods
!----------------------------------------------------------------------------

INTERFACE Abstract1DUVSTWriteData
  MODULE SUBROUTINE obj_WriteData(obj)
    CLASS(Abstract1DUVSTFEM_), INTENT(INOUT) :: obj
  END SUBROUTINE obj_WriteData
END INTERFACE Abstract1DUVSTWriteData
...
END MODULE Abstract1DUVSTFEM_Class
