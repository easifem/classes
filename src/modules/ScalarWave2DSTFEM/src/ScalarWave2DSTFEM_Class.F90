...
MODULE ScalarWave2DSTFEM_Class
...
USE TDGAlgoParam, ONLY: TDGAlgoParam_

PRIVATE

PUBLIC :: ScalarWave2DSTFEM_
PUBLIC :: ElementDataImportFromToml

CHARACTER(*), PARAMETER :: modName = 'ScalarWave2DSTFEM_Class'
CHARACTER(*), PARAMETER :: prefix = "ScalarWave2DSTFEM"
...
! date:   2025-03-22
! summary:  Define ScalarWave2DSTFEM_

TYPE :: ScalarWave2DSTFEM_
  TYPE(ParameterList_) :: param
  TYPE(TDGAlgoParam_) :: algoParam
  TYPE(FEDomain_) :: dom
  ...
  TYPE(MatrixField_), POINTER :: tanmat, massMat, diffMat

  TYPE(STScalarFieldPointer_) :: stscalarFields(3)
  TYPE(STScalarField_), POINTER :: rhs, sol, rhs0

  TYPE(ScalarFieldPointer_) :: scalarFields(3)
  TYPE(ScalarFieldPointer_) :: forceVecs(MAX_ORDER_TIME + 1)
  TYPE(ScalarFieldPointer_) :: tmpVecs(MAX_ORDER_TIME + 1)
  TYPE(ScalarField_), POINTER :: u0, v0, a0
  ...
  TYPE(FEVariable_) :: density, squareWaveSpeed
  ...
  REAL(DFP), ALLOCATABLE :: ks(:, :), ms(:, :), cs(:, :), ke(:, :)
...
END MODULE ScalarWave2DSTFEM_Class
