...
anode = obj%GetSuccessor()
CALL anode%Display("Successor of tree:")
CALL EqualLine()

CALL Initiate(VALUE, 13)
anode = obj%GetNode(VALUE)
anode = anode%GetSuccessor()
CALL anode%Display("Successor of node 13")
CALL EqualLine()
