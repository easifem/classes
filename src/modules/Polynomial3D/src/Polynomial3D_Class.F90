...
INTERFACE
MODULE PURE SUBROUTINE func_Initiate( obj, coeff, degree, name1, name2, name3)
...
INTERFACE
MODULE PURE FUNCTION func_Polynomial3D1( coeff, degree, name1, name2, name3) &
  & RESULT( ans )
  REAL( DFP ), INTENT( IN ) :: coeff( : )
  !! coefficients
  INTEGER( I4B ), INTENT( IN ) :: degree( :, : )
...
INTERFACE
MODULE FUNCTION func_Polynomial3D_Pointer1( coeff, degree, name1, name2, &
  & name3 ) RESULT( ans )
  REAL( DFP ), INTENT( IN ) :: coeff( : )
  !! coefficients
  INTEGER( I4B ), INTENT( IN ) :: degree( :, : )
