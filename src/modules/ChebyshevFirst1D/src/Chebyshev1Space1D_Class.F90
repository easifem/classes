...
! date: 5 Aug 2022
! summary: Space of Chebyshev1 polynomial is defined

MODULE Chebyshev1Space1D_Class
...
!
!{!pages/Chebyshev1Space1D_.md!}

TYPE, EXTENDS(AbstractOrthopolSpace1D_) :: Chebyshev1Space1D_
CONTAINS
  PRIVATE
  ...
  !! Ratio of leading coefficient (n+1)/n
  ...
  PROCEDURE, PUBLIC, PASS(obj) :: GetZeros => &
    & Orthopol_GetZeros
  !! Zeros of Chebyshev1 orthogonal polynomials
...
END TYPE Chebyshev1Space1D_

PUBLIC :: Chebyshev1Space1D_

!----------------------------------------------------------------------------
!                                                  Chebyshev1Space1DPointer_
!----------------------------------------------------------------------------

TYPE :: Chebyshev1Space1DPointer_
  CLASS(Chebyshev1Space1D_), POINTER :: ptr => NULL()
END TYPE Chebyshev1Space1DPointer_

PUBLIC :: Chebyshev1Space1DPointer_

!----------------------------------------------------------------------------
!                                                  Chebyshev1Space1D@Methods
!----------------------------------------------------------------------------

!> authors: Vikas Sharma, Ph. D.
! date: 4 Aug 2022
! summary: Constructor for space of Chebyshev1 polynomials

INTERFACE
  MODULE FUNCTION Chebyshev1Space1D1() RESULT(ans)
    TYPE(Chebyshev1Space1D_) :: ans
    !! Chebyshev Basis of first kind
  END FUNCTION Chebyshev1Space1D1
END INTERFACE

INTERFACE Chebyshev1Space1D
  MODULE PROCEDURE Chebyshev1Space1D1
END INTERFACE Chebyshev1Space1D

PUBLIC :: Chebyshev1Space1D

!----------------------------------------------------------------------------
!                                          Chebyshev1Space1D_Pointer@Methods
!----------------------------------------------------------------------------
...
INTERFACE
  MODULE FUNCTION Chebyshev1Space1D_Pointer1() RESULT(ans)
    CLASS(Chebyshev1Space1D_), POINTER :: ans
    !! Chebyshev1 polynomial of order = 0 to n
  END FUNCTION Chebyshev1Space1D_Pointer1
END INTERFACE

INTERFACE Chebyshev1Space1D_Pointer
  MODULE PROCEDURE Chebyshev1Space1D_Pointer1
END INTERFACE Chebyshev1Space1D_Pointer

PUBLIC :: Chebyshev1Space1D_Pointer
...
INTERFACE
  MODULE SUBROUTINE Orthopol_Final(obj)
    TYPE(Chebyshev1Space1D_), INTENT(INOUT) :: obj
...
INTERFACE
  MODULE PURE FUNCTION Orthopol_GetRecurrenceCoeff(obj, n) RESULT(ans)
    CLASS(Chebyshev1Space1D_), INTENT(IN) :: obj
...
!> author: Vikas Sharma, Ph. D.
! date: 17 Oct 2022
! summary: Returns the leading coeff of orthopol
...
!> author: Vikas Sharma, Ph. D.
! date: 17 Oct 2022
! summary: Returns the ration of leading coeff of orthopol (n+1)/n
...
!> author: Vikas Sharma, Ph. D.
! date: 17 Oct 2022
! summary: Returns the ratio of leading coeff of orthopol (n+1)/n
...
!> author: Vikas Sharma, Ph. D.
! date: 17 Oct 2022
! summary: Returns the ratio of square of norm of orthopol (n+1)/n
...
!> author: Vikas Sharma, Ph. D.
! date: 17 Oct 2022
! summary: Returns the zeros of orthopol
...
!> author: Vikas Sharma, Ph. D.
! date: 17 Oct 2022
! summary: Evaluates the orthopol (0 to n) at single point.
...
!> author: Vikas Sharma, Ph. D.
! date: 17 Oct 2022
! summary: Evaluates the orthopol (0 to n) at several points.
...
!> author: Vikas Sharma, Ph. D.
! date: 17 Oct 2022
! summary: Evaluates the orthopol (order = n ) at single point.
...
!> author: Vikas Sharma, Ph. D.
! date: 17 Oct 2022
! summary: Evaluates the gradient orthopol (order = n ) at single point.
...
!> author: Vikas Sharma, Ph. D.
! date: 17 Oct 2022
! summary: Evaluates the gradient orthopol (order=n) at several points.
...
!> author: Vikas Sharma, Ph. D.
! date: 17 Oct 2022
! summary: Evaluates the gradient of orthopol series at single point.
...
!> author: Vikas Sharma, Ph. D.
! date: 17 Oct 2022
! summary: Evaluates the gradient of orthopol series at several points.
...
!> author: Vikas Sharma, Ph. D.
! date: 13 Oct 2022
! summary: Discrete Chebyshev Transform
...
!> author: Vikas Sharma, Ph. D.
! date: 13 Oct 2022
! summary: Discrete Chebyshev Transform of a function
...
INTERFACE
  MODULE FUNCTION Orthopol_Transform2(obj, n, f, quadType, x1, x2) &
    ...
    !! x1 and x2 are the end points of the interval
    REAL(DFP) :: ans(0:n)
    !! modal values  or coefficients
...
!> author: Vikas Sharma, Ph. D.
! date: 13 Oct 2022
! summary: Discrete Chebyshev Inverse Transform
...
!> author: Vikas Sharma, Ph. D.
! date: 13 Oct 2022
! summary: Returns coefficient for gradient of Chebyshev expansion
...
END MODULE Chebyshev1Space1D_Class
