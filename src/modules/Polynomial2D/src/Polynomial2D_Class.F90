...
INTERFACE
MODULE PURE SUBROUTINE func_Initiate( obj, coeff, degree, name1, name2)
...
INTERFACE
MODULE PURE FUNCTION func_Polynomial2D1( coeff, degree, name1, name2) &
  & RESULT( ans )
  REAL( DFP ), INTENT( IN ) :: coeff( : )
  !! coefficients
  INTEGER( I4B ), INTENT( IN ) :: degree( :, : )
...
INTERFACE
MODULE FUNCTION func_Polynomial2D_Pointer1( coeff, degree, name1, name2) &
  & RESULT( ans )
  REAL( DFP ), INTENT( IN ) :: coeff( : )
  !! coefficients
  INTEGER( I4B ), INTENT( IN ) :: degree( :, : )
