...
PUBLIC :: ScalarWave2DFEM_

CHARACTER(*), PARAMETER :: modName = 'ScalarWave2DFEM_Class'
CHARACTER(*), PARAMETER :: prefix = "ScalarWave2DFEM"
CHARACTER(*), PARAMETER :: default_result_dir = "./results"
CHARACTER(*), PARAMETER :: default_filename = "ScalarWave2DFEM"
...
! date:   2025-03-22
! summary:  Define ScalarWave2DFEM_

TYPE :: ScalarWave2DFEM_
  ...
  TYPE(ScalarFieldPointer_) :: scalarFields(9)
  TYPE(ScalarField_), POINTER :: rhs, sol, rhs0, &
                                 force1, force2, tmp1, &
                                 u0, v0, a0
...
END MODULE ScalarWave2DFEM_Class
