...
CHARACTER(*), PARAMETER :: modName = 'UP2DFEM_Class'
CHARACTER(*), PARAMETER :: prefix = "UP2DFEM"
CHARACTER(*), PARAMETER :: default_result_dir = "./results"
CHARACTER(*), PARAMETER :: default_filename = "UP2DFEM"
...
TYPE :: UP2DFEM_
  ...
  TYPE(MatrixField_) :: massMat, stiffMat

  TYPE(VectorField_) :: rhs, sol, rhs0
  TYPE(VectorField_) :: force1, force2, tmp1
  TYPE(VectorField_) :: u0, v0, a0

  INTEGER(I4B) :: tnbc = 0, tdbc = 0
