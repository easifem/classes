...
MODULE VanGenuchtenMualemModel_Class
...
PRIVATE
PUBLIC :: VanGenuchtenMualemModel_
PUBLIC :: VanGenuchtenMualemModelPointer_
...
!
! The following parameters are defined in the order: ng, pg, smin, smax, k
!
! mg is computed from ng by using mg = 1 - 1/ng

TYPE, EXTENDS(AbstractCapillaryModel_) :: VanGenuchtenMualemModel_
CONTAINS
  ...
  !! Import abstract capillary model from toml
END TYPE VanGenuchtenMualemModel_

!----------------------------------------------------------------------------
!                                                     CapillaryModelPointer_
!----------------------------------------------------------------------------

TYPE :: VanGenuchtenMualemModelPointer_
  CLASS(VanGenuchtenMualemModel_), POINTER :: ptr => NULL()
END TYPE VanGenuchtenMualemModelPointer_
...
INTERFACE
  MODULE SUBROUTINE obj_GetValue1(obj, params, suction, isSuction, sw, krw)
    CLASS(VanGenuchtenMualemModel_), INTENT(INOUT) :: obj
...
END MODULE VanGenuchtenMualemModel_Class
