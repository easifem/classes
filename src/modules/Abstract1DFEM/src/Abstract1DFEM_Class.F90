...
PUBLIC :: Abstract1DFEM_
PUBLIC :: Abstract1DFEMDeallocate
PUBLIC :: Abstract1DFEMImportFromToml
PUBLIC :: Abstract1DFEMDisplay
PUBLIC :: Abstract1DFEMWriteData
PUBLIC :: Abstract1DFEMSet
! PUBLIC :: Abstract1DApplyDirichletBC
PUBLIC :: ElementDataImportFromToml
PUBLIC :: ExportToCSVFile

CHARACTER(*), PARAMETER :: modName = 'Abstract1DFEM_Class'
CHARACTER(*), PARAMETER :: prefix = "Abstract1DFEM"
CHARACTER(*), PARAMETER :: default_result_dir = "./results"
CHARACTER(*), PARAMETER :: default_filename = "Abstract1DFEM"
...
INTERFACE ExportToCSVFile
  MODULE PROCEDURE ExportToCSVFile_xy
END INTERFACE ExportToCSVFile
...
! date:  2025-02-16
! summary:  Define Abstract1DFEM_

TYPE, ABSTRACT :: Abstract1DFEM_
...
CONTAINS
  ...
  PROCEDURE, PUBLIC, PASS(obj) :: SetTotalDOFSpace => obj_SetTotalDOFSpace
  !! set the problem
...
INTERFACE
  MODULE SUBROUTINE obj_Initiate(obj, param)
    CLASS(Abstract1DFEM_), INTENT(INOUT) :: obj
...
INTERFACE Abstract1DFEMDeallocate
  MODULE SUBROUTINE obj_Deallocate(obj)
    CLASS(Abstract1DFEM_), INTENT(INOUT) :: obj
  END SUBROUTINE obj_Deallocate
END INTERFACE Abstract1DFEMDeallocate
...
INTERFACE Abstract1DFEMDisplay
  MODULE SUBROUTINE obj_Display(obj, msg, unitno)
    CLASS(Abstract1DFEM_), INTENT(INOUT) :: obj
    CHARACTER(*), INTENT(IN) :: msg
    INTEGER(I4B), OPTIONAL, INTENT(IN) :: unitno
  END SUBROUTINE obj_Display
END INTERFACE Abstract1DFEMDisplay
...
INTERFACE Abstract1DFEMImportFromToml
  MODULE SUBROUTINE obj_ImportFromToml1(obj, table)
    CLASS(Abstract1DFEM_), INTENT(INOUT) :: obj
    TYPE(toml_table), INTENT(INOUT) :: table
  END SUBROUTINE obj_ImportFromToml1
END INTERFACE Abstract1DFEMImportFromToml
...
INTERFACE Abstract1DFEMSet
  MODULE SUBROUTINE obj_Set(obj)
    CLASS(Abstract1DFEM_), INTENT(INOUT) :: obj
  END SUBROUTINE obj_Set
END INTERFACE Abstract1DFEMSet
...
!> author: Shion Shimizu
! date:   2025-02-18
! summary:  set total dof for space

INTERFACE
  MODULE SUBROUTINE obj_SetTotalDOFSpace(obj)
    CLASS(Abstract1DFEM_), INTENT(INOUT) :: obj
  END SUBROUTINE obj_SetTotalDOFSpace
END INTERFACE
...
INTERFACE Abstract1DFEMWriteData
  MODULE SUBROUTINE obj_WriteData(obj)
    CLASS(Abstract1DFEM_), INTENT(INOUT) :: obj
  END SUBROUTINE obj_WriteData
END INTERFACE Abstract1DFEMWriteData
...
SUBROUTINE ExportToCSVFile_xy(obj, filename, DATA, &
                              keystr, timeVal, timeStep)
  TYPE(CSVFile_), INTENT(INOUT) :: obj
  CHARACTER(*), INTENT(IN) :: filename, keystr
  REAL(DFP), INTENT(IN) :: DATA(:, :)
  REAL(DFP), OPTIONAL, INTENT(IN) :: timeVal
  INTEGER(I4B), OPTIONAL, INTENT(IN) :: timeStep
  ...
  IF (PRESENT(timeStep) .AND. PRESENT(timeVal)) THEN
    aline = "# time-step = "//tostring(timeStep - 1_I4B)// &
            ", time = "//tostring(timeVal)//" s"
    CALL obj%WRITE(aline)
  ELSEIF (PRESENT(timeVal)) THEN
    aline = "# time = "//tostring(timeVal)//" s"
    CALL obj%WRITE(aline)
  ...
  CALL obj%WRITE(keystr)

  CALL obj%WRITE(DATA(:, :))
  CALL obj%DEALLOCATE()

END SUBROUTINE ExportToCSVFile_xy
...
END MODULE Abstract1DFEM_Class
