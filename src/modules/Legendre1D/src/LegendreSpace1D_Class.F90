...
! date: 5 Aug 2022
! summary: Space of Legendre polynomial is defined

MODULE LegendreSpace1D_Class
...
!> author: Vikas Sharma, Ph. D.
! date: 3 Aug 2022
! summary: Legendre orthogonal Basis are defined
!
!{!pages/LegendreSpace1D_.md!}

TYPE, EXTENDS(AbstractOrthopolSpace1D_) :: LegendreSpace1D_
CONTAINS
  PRIVATE
  ...
  PROCEDURE, PUBLIC, PASS(obj) :: GetZeros => &
    & Orthopol_GetZeros
  !! Zeros of Legendre orthogonal polynomials
...
END TYPE LegendreSpace1D_

PUBLIC :: LegendreSpace1D_

!----------------------------------------------------------------------------
!                                                  LegendreSpace1DPointer_
!----------------------------------------------------------------------------

TYPE :: LegendreSpace1DPointer_
  CLASS(LegendreSpace1D_), POINTER :: ptr => NULL()
END TYPE LegendreSpace1DPointer_

PUBLIC :: LegendreSpace1DPointer_

!----------------------------------------------------------------------------
!                                                  LegendreSpace1D@Methods
!----------------------------------------------------------------------------

!> authors: Vikas Sharma, Ph. D.
! date: 4 Aug 2022
! summary: Constructor for space of Legendre polynomials

INTERFACE
  MODULE FUNCTION LegendreSpace1D1() RESULT(ans)
    TYPE(LegendreSpace1D_) :: ans
    !! Legendre Basis of first kind
  END FUNCTION LegendreSpace1D1
END INTERFACE

INTERFACE LegendreSpace1D
  MODULE PROCEDURE LegendreSpace1D1
END INTERFACE LegendreSpace1D

PUBLIC :: LegendreSpace1D

!----------------------------------------------------------------------------
!                                          LegendreSpace1D_Pointer@Methods
!----------------------------------------------------------------------------
...
INTERFACE
  MODULE FUNCTION LegendreSpace1D_Pointer1() RESULT(ans)
    CLASS(LegendreSpace1D_), POINTER :: ans
    !! Legendre polynomial of order = 0 to n
  END FUNCTION LegendreSpace1D_Pointer1
END INTERFACE

INTERFACE LegendreSpace1D_Pointer
  MODULE PROCEDURE LegendreSpace1D_Pointer1
END INTERFACE LegendreSpace1D_Pointer

PUBLIC :: LegendreSpace1D_Pointer
...
!> author: Vikas Sharma, Ph. D.
! date: 4 Aug 2022
! summary: Finalizer for Legendre space

INTERFACE
  MODULE SUBROUTINE Orthopol_Final(obj)
    TYPE(LegendreSpace1D_), INTENT(INOUT) :: obj
...
!> author: Vikas Sharma, Ph. D.
! date: 13 Oct 2022
! summary: Discrete Legendre Inverse Transform
...
!> author: Vikas Sharma, Ph. D.
! date: 13 Oct 2022
! summary: Returns coefficient for gradient of Legendre expansion
...
END MODULE LegendreSpace1D_Class
