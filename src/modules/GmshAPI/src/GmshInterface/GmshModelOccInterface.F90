...
INTERFACE
  FUNCTION gmshModelOccAddCircleArc(startTag, centerTag, endTag, tag, ierr) &
    ...
    IMPORT
    INTEGER(C_INT), VALUE, INTENT(IN) :: startTag, centerTag, endTag, tag
    INTEGER(C_INT), INTENT(OUT) :: ierr
    INTEGER(C_INT) :: ans
...
INTERFACE
  FUNCTION gmshModelOccAddCircle(x, y, z, r, tag, angle1, angle2, ierr) &
    ...
    IMPORT
    INTEGER(C_INT), VALUE, INTENT(IN) :: tag
    REAL(C_DOUBLE), VALUE, INTENT(IN) :: x, y, z, r, angle1, angle2
    INTEGER(C_INT), INTENT(OUT) :: ierr
    INTEGER(C_INT) :: ans
...
INTERFACE
  FUNCTION gmshModelOccAddEllipseArc(startTag, centerTag, majorTag, endTag, &
    ...
    IMPORT
    INTEGER(C_INT), VALUE, INTENT(IN) :: tag, startTag, centerTag, &
                                         majorTag, endTag
    INTEGER(C_INT), INTENT(OUT) :: ierr
    INTEGER(C_INT) :: ans
...
INTERFACE
  FUNCTION gmshModelOccAddEllipse( &
    x, y, z, r1, r2, tag, angle1, angle2, ierr) RESULT(ans) &
    BIND(C, NAME="gmshModelOccAddEllipse")
    IMPORT
    INTEGER(C_INT), VALUE, INTENT(IN) :: tag
    REAL(C_DOUBLE), VALUE, INTENT(IN) :: x, y, z, r1, r2, angle1, angle2
    INTEGER(C_INT), INTENT(OUT) :: ierr
    INTEGER(C_INT) :: ans
...
!
! GMSH_API int gmshModelOccAddBSpline(
...
INTERFACE
  FUNCTION gmshModelOccAddBSpline(pointTags, pointTags_n, tag, degree, &
    ...
    IMPORT
    INTEGER(C_SIZE_T), VALUE, INTENT(IN) :: pointTags_n, weights_n, &
                                            multiplicities_n, knots_n
    INTEGER(C_INT), INTENT(IN) :: pointTags(pointTags_n), &
                                  multiplicities(multiplicities_n)
    REAL(C_DOUBLE), INTENT(IN) :: weights(weights_n), knots(knots_n)
    INTEGER(C_INT), VALUE, INTENT(IN) :: tag, degree
    INTEGER(C_INT), INTENT(OUT) :: ierr
    INTEGER(C_INT) :: ans
...
INTERFACE
  FUNCTION gmshModelOccAddWire( &
    curveTags, curveTags_n, tag, checkClosed, ierr) &
    ...
    INTEGER(C_INT), VALUE, INTENT(IN) :: tag, checkClosed
    INTEGER(C_INT), INTENT(OUT) :: ierr
    INTEGER(C_INT) :: ans
...
INTERFACE
  FUNCTION gmshModelOccAddRectangle(x, y, z, dx, dy, tag, roundedRadius, &
    ...
    IMPORT
    REAL(C_DOUBLE), VALUE, INTENT(IN) :: x, y, z, dx, dy, roundedRadius
    INTEGER(C_INT), VALUE, INTENT(IN) :: tag
    INTEGER(C_INT), INTENT(OUT) :: ierr
    INTEGER(C_INT) :: ans
...
INTERFACE
  FUNCTION gmshModelOccAddDisk(xc, yc, zc, rx, ry, tag, &
    ...
    IMPORT
    REAL(C_DOUBLE), VALUE, INTENT(IN) :: xc, yc, zc, rx, ry
    INTEGER(C_INT), VALUE, INTENT(IN) :: tag
    INTEGER(C_INT), INTENT(OUT) :: ierr
    INTEGER(C_INT) :: ans
...
! points.
!
! GMSH_API int gmshModelOccAddSurfaceFilling(
! const int wireTag,
! const int tag,
! int *pointTags, size_t pointTags_n,
! int *ierr);
...
INTERFACE
  FUNCTION gmshModelOccAddSurfaceFilling(wireTag, tag, pointTags, &
    ...
    IMPORT
    INTEGER(C_INT), VALUE, INTENT(IN) :: tag, wireTag
    INTEGER(C_SIZE_T), VALUE, INTENT(IN) :: pointTags_n
    INTEGER(C_INT), INTENT(IN) :: pointTags(pointTags_n)
    INTEGER(C_INT), INTENT(OUT) :: ierr
    INTEGER(C_INT) :: ans
...
!
! GMSH_API int gmshModelOccAddBSplineFilling(
! const int wireTag,
! const int tag,
! const char *type,
! int *ierr);
...
INTERFACE
  FUNCTION gmshModelOccAddBSplineFilling(wireTag, tag, typeOfFilling, ierr) &
    RESULT(ans) BIND(C, NAME="gmshModelOccAddBSplineFilling")
    IMPORT
    INTEGER(C_INT), VALUE, INTENT(IN) :: tag, wireTag
    TYPE(C_PTR), VALUE, INTENT(IN) :: typeOfFilling
    INTEGER(C_INT), INTENT(OUT) :: ierr
    INTEGER(C_INT) :: ans
...
!
! GMSH_API int gmshModelOccAddBSplineSurface(
! int *pointTags, size_t pointTags_n,
...
INTERFACE
  FUNCTION gmshModelOccAddBSplineSurface( &
    ...
    RESULT(ans) BIND(C, NAME="gmshModelOccAddBSplineSurface")
    IMPORT
    INTEGER(C_SIZE_T), VALUE, INTENT(IN) :: pointTags_n, weights_n, &
                                            knotsU_n, knotsV_n, &
                                            multiplicitiesU_n
    INTEGER(C_SIZE_T), VALUE, INTENT(IN) :: multiplicitiesV_n, wireTags_n
    INTEGER(C_INT), INTENT(IN) :: pointTags(pointTags_n)
    INTEGER(C_INT), INTENT(IN) :: multiplicitiesU(multiplicitiesU_n)
    INTEGER(C_INT), INTENT(IN) :: multiplicitiesV(multiplicitiesV_n)
    INTEGER(C_INT), INTENT(IN) :: wireTags(wireTags_n)
    INTEGER(C_INT), VALUE, INTENT(IN) :: tag, numPointsU, &
                                         degreeU, degreeV, wire3D
    REAL(C_DOUBLE), INTENT(IN) :: weights(weights_n), &
                                  knotsU(knotsU_n), &
                                  knotsV(knotsV_n)
    INTEGER(C_INT), INTENT(OUT) :: ierr
    INTEGER(C_INT) :: ans
...
!
! GMSH_API int gmshModelOccAddBezierSurface(
! int *pointTags, size_t pointTags_n,
! const int numPointsU,
! const int tag,
! int *wireTags, size_t wireTags_n,
...
INTERFACE
  FUNCTION gmshModelOccAddBezierSurface( &
    pointTags, pointTags_n, numPointsU, tag, wireTags, &
    wireTags_n, wire3D, ierr) RESULT(ans) &
    BIND(C, NAME="gmshModelOccAddBezierSurface")
    IMPORT
    INTEGER(C_SIZE_T), VALUE, INTENT(IN) :: pointTags_n, wireTags_n
    INTEGER(C_INT), INTENT(IN) :: pointTags(pointTags_n), &
                                  wireTags(wireTags_n)
    INTEGER(C_INT), VALUE, INTENT(IN) :: tag, numPointsU, wire3D
    INTEGER(C_INT), INTENT(OUT) :: ierr
    INTEGER(C_INT) :: ans
...
!
! GMSH_API int gmshModelOccAddTrimmedSurface(&
...
INTERFACE
  FUNCTION gmshModelOccAddTrimmedSurface( &
    surfaceTag, wireTags, wireTags_n, wire3D, tag, ierr) RESULT(ans) &
    BIND(C, NAME="gmshModelOccAddTrimmedSurface")
    IMPORT
    INTEGER(C_SIZE_T), VALUE, INTENT(IN) :: wireTags_n
    INTEGER(C_INT), INTENT(IN) :: wireTags(wireTags_n)
    INTEGER(C_INT), VALUE, INTENT(IN) :: surfaceTag, tag, wire3D
    INTEGER(C_INT), INTENT(OUT) :: ierr
    INTEGER(C_INT) :: ans
...
! surface loop. Setting `sewing` allows to build a shell made of  cxvcvb
! surfaces that share geometrically identical
! (but topologically different) curves.
!
! GMSH_API int gmshModelOccAddSurfaceLoop(
...
INTERFACE
  FUNCTION gmshModelOccAddSurfaceLoop( &
    surfaceTags, surfaceTags_n, tag, sewing, ierr) RESULT(ans) &
    ...
    INTEGER(C_INT), VALUE, INTENT(IN) :: tag, sewing
    INTEGER(C_INT), INTENT(OUT) :: ierr
    INTEGER(C_INT) :: ans
...
!
! GMSH_API int gmshModelOccAddVolume(&
! int *shellTags, size_t shellTags_n, const int tag, int *ierr);
...
INTERFACE
  FUNCTION gmshModelOccAddSphere( &
    ...
    RESULT(ans) BIND(C, NAME="gmshModelOccAddSphere")
    IMPORT
    INTEGER(C_INT), VALUE, INTENT(IN) :: tag
    REAL(C_DOUBLE), VALUE, INTENT(IN) :: xc, yc, zc, radius, angle1, &
                                         angle2, angle3
    INTEGER(C_INT), INTENT(OUT) :: ierr
    INTEGER(C_INT) :: ans
...
!
! GMSH_API int gmshModelOccAddBox(
! const double x,
! const double y,
! const double z,
! const double dx,
...
INTERFACE
  FUNCTION gmshModelOccAddBox( &
    x, y, z, dx, dy, dz, tag, ierr) RESULT(ans) &
...
INTERFACE
  FUNCTION gmshModelOccAddCylinder( &
    x, y, z, dx, dy, dz, r, tag, angle, ierr) RESULT(ans) &
    BIND(C, NAME="gmshModelOccAddCylinder")
    IMPORT
    INTEGER(C_INT), VALUE, INTENT(IN) :: tag
    REAL(C_DOUBLE), VALUE, INTENT(IN) :: x, y, z, dx, dy, dz, r, angle
    INTEGER(C_INT), INTENT(OUT) :: ierr
    INTEGER(C_INT) :: ans
...
INTERFACE
  FUNCTION gmshModelOccAddCone( &
    x, y, z, dx, dy, dz, r1, r2, tag, angle, ierr) RESULT(ans) &
    BIND(C, NAME="gmshModelOccAddCone")
    IMPORT
    INTEGER(C_INT), VALUE, INTENT(IN) :: tag
    REAL(C_DOUBLE), VALUE, INTENT(IN) :: x, y, z, dx, dy, dz, r1, r2, angle
    INTEGER(C_INT), INTENT(OUT) :: ierr
    INTEGER(C_INT) :: ans
...
INTERFACE
  FUNCTION gmshModelOccAddWedge( &
    x, y, z, dx, dy, dz, tag, ltx, ierr) RESULT(ans) &
    BIND(C, NAME="gmshModelOccAddWedge")
    IMPORT
    INTEGER(C_INT), VALUE, INTENT(IN) :: tag
    REAL(C_DOUBLE), VALUE, INTENT(IN) :: x, y, z, dx, dy, dz, ltx
    INTEGER(C_INT), INTENT(OUT) :: ierr
    INTEGER(C_INT) :: ans
...
INTERFACE
  FUNCTION gmshModelOccAddTorus( &
    x, y, z, r1, r2, tag, angle, ierr) RESULT(ans) &
    BIND(C, NAME="gmshModelOccAddTorus")
    IMPORT
    INTEGER(C_INT), VALUE, INTENT(IN) :: tag
    REAL(C_DOUBLE), VALUE, INTENT(IN) :: x, y, z, r1, r2, angle
    INTEGER(C_INT), INTENT(OUT) :: ierr
    INTEGER(C_INT) :: ans
...
!
! GMSH_API void gmshModelOccAddThruSections(
! int *wireTags, size_t wireTags_n,
...
INTERFACE
  SUBROUTINE gmshModelOccAddThruSections( &
    wireTags, wireTags_n, outDimTags, outDimTags_n, tag, makeSolid, &
    makeRuled, maxDegree, ierr) &
    ...
    INTEGER(C_INT), VALUE, INTENT(IN) :: tag, makeSolid, makeRuled, maxDegree
    INTEGER(C_INT), INTENT(OUT) :: ierr
...
! automatically.
!
! GMSH_API void gmshModelOccAddThickSolid(&
! const int volumeTag,
...
INTERFACE
  SUBROUTINE gmshModelOccAddThickSolid( &
    volumeTag, excludeSurfaceTags, excludeSurfaceTags_n, offset, &
    outDimTags, outDimTags_n, tag, ierr) &
    BIND(C, NAME="gmshModelOccAddThickSolid")
    IMPORT
    INTEGER(C_SIZE_T), VALUE, INTENT(IN) :: excludeSurfaceTags_n
    INTEGER(C_SIZE_T), INTENT(OUT) :: outDimTags_n
    INTEGER(C_INT), INTENT(IN) :: excludeSurfaceTags(excludeSurfaceTags_n)
    TYPE(C_PTR), INTENT(IN) :: outDimTags
    INTEGER(C_INT), VALUE, INTENT(IN) :: volumeTag, tag
...
INTERFACE
  SUBROUTINE gmshModelOccExtrude( &
    ...
    numElements, numElements_n, heights, heights_n, &
    recombine, ierr) &
    BIND(C, NAME="gmshModelOccExtrude")
    IMPORT
    INTEGER(C_SIZE_T), VALUE, INTENT(IN) :: dimTags_n, heights_n, &
                                            numElements_n
    INTEGER(C_SIZE_T), INTENT(OUT) :: outDimTags_n
...
INTERFACE
  SUBROUTINE gmshModelOccAddPipe( &
    dimTags, dimTags_n, wireTag, outDimTags, outDimTags_n, &
    trihedron, ierr) BIND(C, NAME="gmshModelOccAddPipe")
    IMPORT
    ...
    TYPE(C_PTR), INTENT(IN) :: outDimTags
    INTEGER(C_SIZE_T), INTENT(OUT) :: outDimTags_n
    TYPE(C_PTR), VALUE, INTENT(IN) :: trihedron
    INTEGER(C_INT), INTENT(OUT) :: ierr
...
INTERFACE
  SUBROUTINE gmshModelOccFillet( &
    volumeTags, volumeTags_n, curveTags, curveTags_n, radii, &
    radii_n, outDimTags, outDimTags_n, removeVolume, ierr) &
    BIND(C, NAME="gmshModelOccFillet")
    IMPORT
    INTEGER(C_SIZE_T), VALUE, INTENT(IN) :: volumeTags_n, &
                                            curveTags_n, radii_n
    INTEGER(C_INT), INTENT(IN) :: volumeTags(volumeTags_n)
    INTEGER(C_INT), INTENT(IN) :: curveTags(curveTags_n)
    REAL(C_DOUBLE), INTENT(IN) :: radii(radii_n)
    TYPE(C_PTR), INTENT(IN) :: outDimTags
    INTEGER(C_SIZE_T), INTENT(OUT) :: outDimTags_n
...
INTERFACE
  SUBROUTINE gmshModelOccChamfer( &
    volumeTags, volumeTags_n, curveTags, curveTags_n, surfaceTags, &
    surfaceTags_n, distances, distances_n, outDimTags, &
    outDimTags_n, removeVolume, ierr) &
    ...
    REAL(C_DOUBLE), INTENT(IN) :: distances(distances_n)
    TYPE(C_PTR), INTENT(IN) :: outDimTags
    INTEGER(C_SIZE_T), INTENT(OUT) :: outDimTags_n
    INTEGER(C_INT), VALUE, INTENT(IN) :: removeVolume
    INTEGER(C_INT), INTENT(OUT) :: ierr
...
INTERFACE
  SUBROUTINE gmshModelOccFuse( &
    objectDimTags, objectDimTags_n, toolDimTags, toolDimTags_n, &
    outDimTags, outDimTags_n, outDimTagsMap, outDimTagsMap_n, &
    outDimTagsMap_nn, tag, removeObject, removeTool, ierr) &
    BIND(C, NAME="gmshModelOccFuse")
    IMPORT
    INTEGER(C_SIZE_T), VALUE, INTENT(IN) :: objectDimTags_n
    INTEGER(C_INT), INTENT(IN) :: objectDimTags(objectDimTags_n)
    INTEGER(C_SIZE_T), VALUE, INTENT(IN) :: toolDimTags_n
    INTEGER(C_INT), INTENT(IN) :: toolDimTags(toolDimTags_n)
    TYPE(C_PTR), INTENT(IN) :: outDimTags
    INTEGER(C_INT), INTENT(OUT) :: outDimTags_n
    TYPE(C_PTR), INTENT(IN) :: outDimTagsMap
    TYPE(C_PTR), INTENT(IN) :: outDimTagsMap_n
    INTEGER(C_SIZE_T), INTENT(OUT) :: outDimTagsMap_nn
    INTEGER(C_INT), VALUE, INTENT(IN) :: tag
...
!
! GMSH_API void gmshModelOccIntersect(
! int *objectDimTags, size_t objectDimTags_n,
! int *toolDimTags, size_t toolDimTags_n,
! int **outDimTags, size_t *outDimTags_n,
! int ***outDimTagsMap, size_t **outDimTagsMap_n, size_t *outDimTagsMap_nn,
! const int tag,
...
INTERFACE
  SUBROUTINE gmshModelOccIntersect( &
    objectDimTags, objectDimTags_n, toolDimTags, toolDimTags_n, &
    outDimTags, outDimTags_n, outDimTagsMap, &
    outDimTagsMap_n, outDimTagsMap_nn, tag, removeObject, removeTool, &
    ierr) BIND(C, NAME="gmshModelOccIntersect")
    IMPORT
    INTEGER(C_SIZE_T), VALUE, INTENT(IN) :: objectDimTags_n
    INTEGER(C_INT), INTENT(IN) :: objectDimTags(objectDimTags_n)
    INTEGER(C_SIZE_T), VALUE, INTENT(IN) :: toolDimTags_n
...
!
! GMSH_API void gmshModelOccFragment(
! int *objectDimTags, size_t objectDimTags_n,
! int *toolDimTags, size_t toolDimTags_n,
! int **outDimTags, size_t *outDimTags_n,
! int ***outDimTagsMap, size_t **outDimTagsMap_n, size_t *outDimTagsMap_nn,
...
! GMSH_API void gmshModelOccHealShapes(
! int **outDimTags, size_t *outDimTags_n,
...
INTERFACE
  SUBROUTINE gmshModelOccHealShapes( &
    outDimTags, outDimTags_n, dimTags, dimTags_n, tolerance, &
    fixDegenerated, fixSmallEdges, fixSmallFaces, &
...
! "step" or "iges")
!
! GMSH_API void gmshModelOccImportShapes(
! const char *fileName,
! int **outDimTags, size_t *outDimTags_n,
...
INTERFACE
  SUBROUTINE gmshModelOccImportShapes( &
    fileName, outDimTags, outDimTags_n, highestDimOnly, FORMAT, ierr) &
...
INTERFACE
  SUBROUTINE gmshModelOccImportShapesNativePointer( &
    shape, outDimTags, outDimTags_n, highestDimOnly, ierr) &
...
! == 0).
!
! GMSH_API void gmshModelOccGetEntitiesInBoundingBox(
! const double xmin,
! const double ymin,
! const double zmin,
! const double xmax,
...
!
! GMSH_API void gmshModelOccGetBoundingBox(
! const int dim,
! const int tag,
! double *xmin,
! double *ymin,
...
!
! GMSH_API void gmshModelOccGetMass(
! const int dim,
! const int tag,
! double *mass,
! int *ierr);
...
INTERFACE
  SUBROUTINE gmshModelOccGetMatrixOfInertia(dim, tag, mat, mat_n, ierr) &
    ...
    INTEGER(C_INT), INTENT(OUT) :: mat_n
    INTEGER(C_INT), INTENT(OUT) :: ierr
...
END MODULE GmshModelOccInterface
