...
TYPE, EXTENDS(PrismH1FE_) :: PrismH1LagrangeFE_
CONTAINS
...
INTERFACE PrismH1LagrangeFEPointer
  MODULE FUNCTION obj_PrismH1LagrangeFEPointer2( &
    ...
    TYPE(PrismH1LagrangeFE_), POINTER :: ans
    !! PrismH1LagrangeFE_ pointer
  END FUNCTION obj_PrismH1LagrangeFEPointer2
END INTERFACE PrismH1LagrangeFEPointer
