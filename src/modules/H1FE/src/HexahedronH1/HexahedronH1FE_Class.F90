...
PUBLIC :: HexahedronH1FE_
PUBLIC :: HexahedronH1FEPointer_

CHARACTER(*), PARAMETER :: modName = "HexahedronH1FE_Class"
...
TYPE, ABSTRACT, EXTENDS(AbstractFE_) :: HexahedronH1FE_
CONTAINS
...
END TYPE HexahedronH1FE_

!----------------------------------------------------------------------------
!                                                    HexahedronH1FEPointer_
!----------------------------------------------------------------------------

TYPE :: HexahedronH1FEPointer_
  CLASS(HexahedronH1FE_), POINTER :: ptr => NULL()
END TYPE HexahedronH1FEPointer_
...
INTERFACE
  MODULE SUBROUTINE obj_GetQuadraturePoints(obj, quad)
    CLASS(HexahedronH1FE_), INTENT(INOUT) :: obj
...
END MODULE HexahedronH1FE_Class
