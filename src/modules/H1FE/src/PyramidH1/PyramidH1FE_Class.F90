...
PUBLIC :: PyramidH1FE_
PUBLIC :: PyramidH1FEPointer_

CHARACTER(*), PARAMETER :: modName = "PyramidH1FE_Class"
...
TYPE, ABSTRACT, EXTENDS(AbstractFE_) :: PyramidH1FE_
CONTAINS
...
END TYPE PyramidH1FE_

!----------------------------------------------------------------------------
!                                                    PyramidH1FEPointer_
!----------------------------------------------------------------------------

TYPE :: PyramidH1FEPointer_
  CLASS(PyramidH1FE_), POINTER :: ptr => NULL()
END TYPE PyramidH1FEPointer_
...
INTERFACE
  MODULE SUBROUTINE obj_GetQuadraturePoints(obj, quad)
    CLASS(PyramidH1FE_), INTENT(INOUT) :: obj
