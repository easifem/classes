...
!> author: Vikas Sharma, Ph. D.
! date: 17 Oct 2022
! summary: Abstract datatype for space of orthogonal functions
!
...
CONTAINS
  ...
  PROCEDURE, PUBLIC, PASS(obj) :: GetZeros => &
    & Orthopol_GetZeros
  !! Zeros of Jacobi orthogonal polynomials
  ...
  GENERIC, PUBLIC :: EvalAll => EvalAll1, EvalAll2
  !!
  ...
  GENERIC, PUBLIC :: Eval => Eval1, Eval2
  !!
  ...
  !! Evaluate the series or orthogonal expansion
  GENERIC, PUBLIC :: EvalSum => EvalSum1, EvalSum2
  !!
  ...
  GENERIC, PUBLIC :: GradientEvalAll => GradientEvalAll1, GradientEvalAll2
  !!
  ...
  !! Evaluate Gradient of orthopol order n<N at several points
  GENERIC, PUBLIC :: GradientEval => GradientEval1, GradientEval2
  !! Generic method to evaluate gradient of orthopol
  ...
  !! Evaluate the kth gradient of series of orthopol
  GENERIC, PUBLIC :: GradientEvalSum => &
    & GradientEvalSum1, GradientEvalSum2, &
    & GradientEvalSum3, GradientEvalSum4
  !!
  PROCEDURE, PRIVATE, PASS(obj) :: Transform1 => Orthopol_Transform1
  !! Orthogonal transform
  PROCEDURE, PRIVATE, PASS(obj) :: Transform2 => Orthopol_Transform2
  !! Orthogonal transform
  GENERIC, PUBLIC :: Transform => Transform1, Transform2
  !!
  ...
  !! Inverse orthogonal transform
  GENERIC, PUBLIC :: InvTransform => InvTransform1, InvTransform2
  !!
...
INTERFACE
  MODULE PURE SUBROUTINE Orthopol_SetParam(obj, domain)
    CLASS(AbstractOrthopolSpace1D_), INTENT(INOUT) :: obj
...
INTERFACE AbstractOrthopolSpace1DDisplay
  MODULE PROCEDURE Orthopol_Display
END INTERFACE AbstractOrthopolSpace1DDisplay

PUBLIC :: AbstractOrthopolSpace1DDisplay
...
!> author: Vikas Sharma, Ph. D.
! date: 17 Oct 2022
! summary: Returns the recurrence coefficient of standard polynomials
...
!> author: Vikas Sharma, Ph. D.
! date: 13 Oct 2022
! summary: Discrete Orthopol Transform
...
!> author: Vikas Sharma, Ph. D.
! date: 13 Oct 2022
! summary: Discrete Jacobi Inverse Transform
...
!> author: Vikas Sharma, Ph. D.
! date: 13 Oct 2022
! summary: Returns coefficient for gradient of orthopol expansion
