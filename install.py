...
if _os == 'Windows':
    ...
    if user_query:
        ...
        cmake_def += '-G "Ninja" -DUSE_GMSH_SDK:BOOL=OFF -DUSE_OpenMP:BOOL=ON -DUSE_LAPACK95:BOOL=ON -DUSE_BLAS95:BOOL=ON -DCMAKE_BUILD_TYPE:STRING=Release -DBUILD_SHARED_LIBS:BOOL=ON -DCMAKE_INSTALL_PREFIX:PATH=${EASIFEM_CLASSES} -DUSE_GMSH_SDK:BOOL=ON'
